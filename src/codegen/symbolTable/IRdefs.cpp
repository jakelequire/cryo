 ...
 *                                                                              *
 ********************************************************************************/
#include "codegen/symTable/IRdefs.hpp"
...
namespace Cryo
{
    ...
    IRTypeSymbol IRSymbolManager::createProtoTypeSymbol(llvm::StructType *type, const std::string &name, bool isProto)
    {
        return IRTypeSymbol(type, name, isProto);
    }
