...
"|--------------------|---------------|-----------------------------------------------------------------|\n"
"| *env               | -env          | [none] Starts a virtual environment to write / debug cryo code. |\n"
"|                    |               |                                                                 |\n"
"|--------------------|---------------|-----------------------------------------------------------------|\n"
"| init               | -init  --init | [none] Initializes cryo project in the current directory.       |\n"
"|                    |               |                                                                 |\n"
"|--------------------|---------------|-----------------------------------------------------------------|\n"
"| *run               | -r --run      | [none] Runs the cryo project in the current directory.          |\n"
"|                    |               |                                                                 |\n"
"+------------------------------------------------------------------------------------------------------+\n"
"\n"
" * - Unimplemented\n";
