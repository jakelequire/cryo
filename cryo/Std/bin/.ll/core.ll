...
@.str.93825037320048 = unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@.str.93825042216928 = unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@.str.93825044312448 = unnamed_addr constant [4 x i8] c"%c\0A\00", align 1
...
entry:
  ...
  %printf_export = call i32 (ptr, ...) @printf_export(ptr @.str.93825037320048, i32 %val.load)
...
entry:
  %printf_export = call i32 (ptr, ...) @printf_export(ptr @.str.93825037320048, i32 %value)
  %calltmp = alloca i32, align 4
  store i32 %printf_export, ptr %calltmp, align 4
  ret void
}
...
entry:
  ...
  %printf_export = call i32 (ptr, ...) @printf_export(ptr @.str.93825042216928, ptr %val.load)
  %calltmp = alloca i32, align 4
  store i32 %printf_export, ptr %calltmp, align 4
  ret void
}
...
entry:
  %printf_export = call i32 (ptr, ...) @printf_export(ptr @.str.93825044312448, i8 %value)
  %calltmp = alloca i32, align 4
  store i32 %printf_export, ptr %calltmp, align 4
  ret void
}
