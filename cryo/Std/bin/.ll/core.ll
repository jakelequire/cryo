...
@.str.93825037372576 = unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@.str.93825042269456 = unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@.str.93825044364976 = unnamed_addr constant [4 x i8] c"%c\0A\00", align 1
...
entry:
  ...
  %printf_export = call i32 (ptr, ...) @printf_export(ptr @.str.93825037372576, i32 %val.load)
...
entry:
  %printf_export = call i32 (ptr, ...) @printf_export(ptr @.str.93825037372576, i32 %value)
  %calltmp = alloca i32, align 4
  store i32 %printf_export, ptr %calltmp, align 4
  ret void
}
...
entry:
  ...
  %printf_export = call i32 (ptr, ...) @printf_export(ptr @.str.93825042269456, ptr %val.load)
  %calltmp = alloca i32, align 4
  store i32 %printf_export, ptr %calltmp, align 4
  ret void
}
...
entry:
  %printf_export = call i32 (ptr, ...) @printf_export(ptr @.str.93825044364976, i8 %value)
  %calltmp = alloca i32, align 4
  store i32 %printf_export, ptr %calltmp, align 4
  ret void
}
